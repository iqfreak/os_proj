...
0000000080000060 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000006e:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdb2af>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000158:	0cc50513          	addi	a0,a0,204 # 80012220 <cons>
  ...
  while(n > 0){
    ...
    80000164:	0c048493          	addi	s1,s1,192 # 80012220 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    8000016c:	15090913          	addi	s2,s2,336 # 800122b8 <cons+0x98>
  while(n > 0){
    ...
    800001a4:	08070713          	addi	a4,a4,128 # 80012220 <cons>
    ...
    800001ee:	03650513          	addi	a0,a0,54 # 80012220 <cons>
  ...
  return target - n;
    ...
    80000218:	0af72223          	sw	a5,164(a4) # 800122b8 <cons+0x98>
  ...
  release(&cons.lock);
    ...
    8000022e:	ff650513          	addi	a0,a0,-10 # 80012220 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80000282:	fa250513          	addi	a0,a0,-94 # 80012220 <cons>
  ...
  release(&cons.lock);
    ...
    800002a8:	f7c50513          	addi	a0,a0,-132 # 80012220 <cons>
  ...
  switch(c){
    ...
    800002c6:	f5e70713          	addi	a4,a4,-162 # 80012220 <cons>
    ...
    800002ec:	f3878793          	addi	a5,a5,-200 # 80012220 <cons>
    ...
    8000031a:	fa27a783          	lw	a5,-94(a5) # 800122b8 <cons+0x98>
    ...
    80000330:	ef470713          	addi	a4,a4,-268 # 80012220 <cons>
    80000334:	0a072783          	lw	a5,160(a4)
    80000338:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    8000033c:	00012497          	auipc	s1,0x12
    80000340:	ee448493          	addi	s1,s1,-284 # 80012220 <cons>
    while(cons.e != cons.w &&
    ...
    80000382:	ea270713          	addi	a4,a4,-350 # 80012220 <cons>
    ...
    80000398:	f2f72623          	sw	a5,-212(a4) # 800122c0 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    800003b6:	e6e78793          	addi	a5,a5,-402 # 80012220 <cons>
    ...
    800003da:	eec7a323          	sw	a2,-282(a5) # 800122bc <cons+0x9c>
        wakeup(&cons.r);
    800003de:	00012517          	auipc	a0,0x12
    800003e2:	eda50513          	addi	a0,a0,-294 # 800122b8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000400:	e2450513          	addi	a0,a0,-476 # 80012220 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000410:	fac78793          	addi	a5,a5,-84 # 800223b8 <devsw>
...
printf(char *fmt, ...)
{
  ...
  locking = pr.locking;
    ...
    800004e4:	e007a783          	lw	a5,-512(a5) # 800122e0 <pr+0x18>
  ...
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    ...
    80000530:	d9c50513          	addi	a0,a0,-612 # 800122c8 <pr>
  ...
  return 0;
    ...
    8000078a:	b4250513          	addi	a0,a0,-1214 # 800122c8 <pr>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    800007a4:	b407a023          	sw	zero,-1216(a5) # 800122e0 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    800007c8:	a0f72e23          	sw	a5,-1508(a4) # 8000a1e0 <panicked>
  for(;;)
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    800007dc:	af048493          	addi	s1,s1,-1296 # 800122c8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80000844:	aa850513          	addi	a0,a0,-1368 # 800122e8 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80000868:	97c7a783          	lw	a5,-1668(a5) # 8000a1e0 <panicked>
...
uartstart()
{
  while(1){
    ...
    8000089e:	94e7b783          	ld	a5,-1714(a5) # 8000a1e8 <uart_tx_r>
    800008a2:	0000a717          	auipc	a4,0xa
    800008a6:	94e73703          	ld	a4,-1714(a4) # 8000a1f0 <uart_tx_w>
    800008aa:	08f70263          	beq	a4,a5,8000092e <uartstart+0x94>
{
    ...
    800008cc:	a20a8a93          	addi	s5,s5,-1504 # 800122e8 <uart_tx_lock>
    uart_tx_r += 1;
    800008d0:	0000a497          	auipc	s1,0xa
    800008d4:	91848493          	addi	s1,s1,-1768 # 8000a1e8 <uart_tx_r>
    ...
    800008e0:	91498993          	addi	s3,s3,-1772 # 8000a1f0 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
000000008000093a <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000950:	99c50513          	addi	a0,a0,-1636 # 800122e8 <uart_tx_lock>
    80000954:	2a0000ef          	jal	80000bf4 <acquire>
  if(panicked){
    80000958:	0000a797          	auipc	a5,0xa
    8000095c:	8887a783          	lw	a5,-1912(a5) # 8000a1e0 <panicked>
    80000960:	efbd                	bnez	a5,800009de <uartputc+0xa4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80000962:	0000a717          	auipc	a4,0xa
    80000966:	88e73703          	ld	a4,-1906(a4) # 8000a1f0 <uart_tx_w>
    8000096a:	0000a797          	auipc	a5,0xa
    8000096e:	87e7b783          	ld	a5,-1922(a5) # 8000a1e8 <uart_tx_r>
    80000972:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    80000976:	00012997          	auipc	s3,0x12
    8000097a:	97298993          	addi	s3,s3,-1678 # 800122e8 <uart_tx_lock>
    8000097e:	0000a497          	auipc	s1,0xa
    80000982:	86a48493          	addi	s1,s1,-1942 # 8000a1e8 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80000986:	0000a917          	auipc	s2,0xa
    8000098a:	86a90913          	addi	s2,s2,-1942 # 8000a1f0 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    800009ac:	94048493          	addi	s1,s1,-1728 # 800122e8 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    800009c0:	82e7ba23          	sd	a4,-1996(a5) # 8000a1f0 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000a24:	8c848493          	addi	s1,s1,-1848 # 800122e8 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a5a:	afa78793          	addi	a5,a5,-1286 # 80023550 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000a76:	8ae90913          	addi	s2,s2,-1874 # 80012320 <kmem>
...
0000000080000af0 <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b04:	82050513          	addi	a0,a0,-2016 # 80012320 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000b14:	a4050513          	addi	a0,a0,-1472 # 80023550 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000b32:	7f248493          	addi	s1,s1,2034 # 80012320 <kmem>
  ...
  if(r)
    ...
    80000b46:	7de50513          	addi	a0,a0,2014 # 80012320 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000b6a:	7ba50513          	addi	a0,a0,1978 # 80012320 <kmem>
    ...
    80000d34:	00c587b3          	add	a5,a1,a2
{
    ...
    80000d3c:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdbab1>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000e72:	38a70713          	addi	a4,a4,906 # 8000a1f8 <started>
  if(cpuid() == 0){
  ...
  scheduler();        
    ...
    80000f0e:	2ef72723          	sw	a5,750(a4) # 8000a1f8 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000f22:	2e27b783          	ld	a5,738(a5) # 8000a200 <kernel_pagetable>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80000f90:	3a5d                	addiw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdbaa7>
...
000000008000119e <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    800011ae:	04a7bb23          	sd	a0,86(a5) # 8000a200 <kernel_pagetable>
}
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001780:	ff448493          	addi	s1,s1,-12 # 80012770 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800017ac:	9c8a8a93          	addi	s5,s5,-1592 # 80018170 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    8000181e:	b2650513          	addi	a0,a0,-1242 # 80012340 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    80001832:	b2a50513          	addi	a0,a0,-1238 # 80012358 <wait_lock>
    80001836:	b3eff0ef          	jal	80000b74 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    8000183a:	00011497          	auipc	s1,0x11
    8000183e:	f3648493          	addi	s1,s1,-202 # 80012770 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001872:	902a0a13          	addi	s4,s4,-1790 # 80018170 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    800018d4:	aa050513          	addi	a0,a0,-1376 # 80012370 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    800018f8:	a4c70713          	addi	a4,a4,-1460 # 80012340 <pid_lock>
...
000000008000194a <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    8000195a:	9ea90913          	addi	s2,s2,-1558 # 80012340 <pid_lock>
...
0000000080001aa2 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001ab2:	cc248493          	addi	s1,s1,-830 # 80012770 <proc>
    80001ab6:	00016917          	auipc	s2,0x16
    80001aba:	6ba90913          	addi	s2,s2,1722 # 80018170 <tickslock>
    acquire(&p->lock);
...
0000000080001b48 <userinit>:
{
  ...
  initproc = p;
    ...
    80001b5c:	6aa7b823          	sd	a0,1712(a5) # 8000a208 <initproc>
...
0000000080001c06 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001cd6:	68648493          	addi	s1,s1,1670 # 80012358 <wait_lock>
...
0000000080001d14 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001d38:	60c70713          	addi	a4,a4,1548 # 80012340 <pid_lock>
    80001d3c:	975a                	add	a4,a4,s6
    80001d3e:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001d42:	00010717          	auipc	a4,0x10
    80001d46:	63670713          	addi	a4,a4,1590 # 80012378 <cpus+0x8>
    ...
    80001d54:	5f0a0a13          	addi	s4,s4,1520 # 80012340 <pid_lock>
    80001d58:	9a3e                	add	s4,s4,a5
        found = 1;
    80001d5a:	4b85                	li	s7,1
    for(p = proc; p < &proc[NPROC]; p++) {
    80001d5c:	00016997          	auipc	s3,0x16
    80001d60:	41498993          	addi	s3,s3,1044 # 80018170 <tickslock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001dc0:	9b448493          	addi	s1,s1,-1612 # 80012770 <proc>
      if(p->state == RUNNABLE) {
...
0000000080001dc8 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001dec:	55870713          	addi	a4,a4,1368 # 80012340 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001e12:	53290913          	addi	s2,s2,1330 # 80012340 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001e2a:	55258593          	addi	a1,a1,1362 # 80012378 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f12:	86248493          	addi	s1,s1,-1950 # 80012770 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f1e:	25690913          	addi	s2,s2,598 # 80018170 <tickslock>
...
0000000080001f64 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80001f7a:	7fa48493          	addi	s1,s1,2042 # 80012770 <proc>
      pp->parent = initproc;
    80001f7e:	00008a17          	auipc	s4,0x8
    80001f82:	28aa0a13          	addi	s4,s4,650 # 8000a208 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001f86:	00016997          	auipc	s3,0x16
    80001f8a:	1ea98993          	addi	s3,s3,490 # 80018170 <tickslock>
...
0000000080001fba <exit>:
{
  ...
  if(p == initproc)
    ...
    80001fd6:	2367b783          	ld	a5,566(a5) # 8000a208 <initproc>
  ...
  acquire(&wait_lock);
    ...
    8000201e:	33e48493          	addi	s1,s1,830 # 80012358 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002070:	70448493          	addi	s1,s1,1796 # 80012770 <proc>
    80002074:	00016997          	auipc	s3,0x16
    80002078:	0fc98993          	addi	s3,s3,252 # 80018170 <tickslock>
    acquire(&p->lock);
...
0000000080002110 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002134:	22850513          	addi	a0,a0,552 # 80012358 <wait_lock>
    ...
    80002146:	02e98993          	addi	s3,s3,46 # 80018170 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000214a:	00010c17          	auipc	s8,0x10
    8000214e:	20ec0c13          	addi	s8,s8,526 # 80012358 <wait_lock>
    ...
    80002180:	1dc50513          	addi	a0,a0,476 # 80012358 <wait_lock>
    ...
    800021ac:	1b050513          	addi	a0,a0,432 # 80012358 <wait_lock>
    ...
    800021f4:	58048493          	addi	s1,s1,1408 # 80012770 <proc>
    800021f8:	b7e1                	j	800021c0 <wait+0xb0>
      release(&wait_lock);
    800021fa:	00010517          	auipc	a0,0x10
    800021fe:	15e50513          	addi	a0,a0,350 # 80012358 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800022c4:	60848493          	addi	s1,s1,1544 # 800128c8 <proc+0x158>
    800022c8:	00016917          	auipc	s2,0x16
    800022cc:	00090913          	mv	s2,s2
    if(p->state == UNUSED)
      continue;
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800023c0:	db450513          	addi	a0,a0,-588 # 80018170 <tickslock>
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    800024a8:	ccc48493          	addi	s1,s1,-820 # 80018170 <tickslock>
    800024ac:	8526                	mv	a0,s1
    800024ae:	f46fe0ef          	jal	80000bf4 <acquire>
    ticks++;
    800024b2:	00008517          	auipc	a0,0x8
    800024b6:	d5e50513          	addi	a0,a0,-674 # 8000a210 <ticks>
...
syscall(void)
{
  ...
  num = p->trapframe->a7;
    ...
    80002812:	0a893783          	ld	a5,168(s2) # 80018370 <bcache+0x1e8>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002926:	84e50513          	addi	a0,a0,-1970 # 80018170 <tickslock>
    8000292a:	acafe0ef          	jal	80000bf4 <acquire>
  ticks0 = ticks;
    8000292e:	00008917          	auipc	s2,0x8
    80002932:	8e292903          	lw	s2,-1822(s2) # 8000a210 <ticks>
  while(ticks - ticks0 < n){
    ...
    80002944:	83098993          	addi	s3,s3,-2000 # 80018170 <tickslock>
    80002948:	00008497          	auipc	s1,0x8
    8000294c:	8c848493          	addi	s1,s1,-1848 # 8000a210 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002978:	7fc50513          	addi	a0,a0,2044 # 80018170 <tickslock>
  ...
  return 0;
    ...
    80002996:	7de50513          	addi	a0,a0,2014 # 80018170 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800029d6:	79e50513          	addi	a0,a0,1950 # 80018170 <tickslock>
    800029da:	a1afe0ef          	jal	80000bf4 <acquire>
  xticks = ticks;
    800029de:	00008497          	auipc	s1,0x8
    800029e2:	8324a483          	lw	s1,-1998(s1) # 8000a210 <ticks>
  release(&tickslock);
    800029e6:	00015517          	auipc	a0,0x15
    800029ea:	78a50513          	addi	a0,a0,1930 # 80018170 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002a1e:	76e50513          	addi	a0,a0,1902 # 80018188 <bcache>
    80002a22:	952fe0ef          	jal	80000b74 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002a26:	0001d797          	auipc	a5,0x1d
    80002a2a:	76278793          	addi	a5,a5,1890 # 80020188 <bcache+0x8000>
    80002a2e:	0001e717          	auipc	a4,0x1e
    80002a32:	9c270713          	addi	a4,a4,-1598 # 800203f0 <bcache+0x8268>
    80002a36:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002a3a:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002a3e:	00015497          	auipc	s1,0x15
    80002a42:	76248493          	addi	s1,s1,1890 # 800181a0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002a9e:	6ee50513          	addi	a0,a0,1774 # 80018188 <bcache>
    80002aa2:	952fe0ef          	jal	80000bf4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002aa6:	0001e497          	auipc	s1,0x1e
    80002aaa:	99a4b483          	ld	s1,-1638(s1) # 80020440 <bcache+0x82b8>
    80002aae:	0001e797          	auipc	a5,0x1e
    80002ab2:	94278793          	addi	a5,a5,-1726 # 800203f0 <bcache+0x8268>
    ...
    80002ada:	6b250513          	addi	a0,a0,1714 # 80018188 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002af0:	94c4b483          	ld	s1,-1716(s1) # 80020438 <bcache+0x82b0>
    80002af4:	0001e797          	auipc	a5,0x1e
    80002af8:	8fc78793          	addi	a5,a5,-1796 # 800203f0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002b2c:	66050513          	addi	a0,a0,1632 # 80018188 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002bb4:	5d850513          	addi	a0,a0,1496 # 80018188 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002bd6:	5b678793          	addi	a5,a5,1462 # 80020188 <bcache+0x8000>
    80002bda:	2b87b703          	ld	a4,696(a5)
    80002bde:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002be0:	0001e717          	auipc	a4,0x1e
    80002be4:	81070713          	addi	a4,a4,-2032 # 800203f0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002bf8:	59450513          	addi	a0,a0,1428 # 80018188 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002c28:	56450513          	addi	a0,a0,1380 # 80018188 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002c3a:	55250513          	addi	a0,a0,1362 # 80018188 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002c5c:	53050513          	addi	a0,a0,1328 # 80018188 <bcache>
  ...
  release(&bcache.lock);
    ...
    80002c6e:	51e50513          	addi	a0,a0,1310 # 80018188 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002c96:	bd27a783          	lw	a5,-1070(a5) # 80020864 <sb+0x1c>
...
0000000080002cec <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80002cfa:	b567a783          	lw	a5,-1194(a5) # 8002084c <sb+0x4>
    ...
    80002d1a:	b32b0b13          	addi	s6,s6,-1230 # 80020848 <sb>
...
0000000080002ee0 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ef8:	97450513          	addi	a0,a0,-1676 # 80020868 <itable>
    80002efc:	cf9fd0ef          	jal	80000bf4 <acquire>
  empty = 0;
    80002f00:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002f02:	0001e497          	auipc	s1,0x1e
    80002f06:	97e48493          	addi	s1,s1,-1666 # 80020880 <itable+0x18>
    80002f0a:	0001f697          	auipc	a3,0x1f
    80002f0e:	40668693          	addi	a3,a3,1030 # 80022310 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002f3a:	93250513          	addi	a0,a0,-1742 # 80020868 <itable>
  ...
  release(&itable.lock);
    ...
    80002f66:	90650513          	addi	a0,a0,-1786 # 80020868 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    80002fa8:	8a498993          	addi	s3,s3,-1884 # 80020848 <sb>
  ...
  initlog(dev, &sb);
    ...
    80002fd4:	87858593          	addi	a1,a1,-1928 # 80020848 <sb>
...
0000000080002ff8 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003012:	85a50513          	addi	a0,a0,-1958 # 80020868 <itable>
    80003016:	b5ffd0ef          	jal	80000b74 <initlock>
  for(i = 0; i < NINODE; i++) {
    8000301a:	0001e497          	auipc	s1,0x1e
    8000301e:	87648493          	addi	s1,s1,-1930 # 80020890 <itable+0x28>
    80003022:	0001f997          	auipc	s3,0x1f
    80003026:	2fe98993          	addi	s3,s3,766 # 80022320 <log+0x10>
...
0000000080003050 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    8000305c:	7fc72703          	lw	a4,2044(a4) # 80020854 <sb+0xc>
    ...
    8000307c:	7d0a0a13          	addi	s4,s4,2000 # 80020848 <sb>
...
000000008000310c <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003124:	7405a583          	lw	a1,1856(a1) # 80020860 <sb+0x18>
...
000000008000318a <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    8000319a:	6d250513          	addi	a0,a0,1746 # 80020868 <itable>
  ...
  release(&itable.lock);
    ...
    800031ac:	6c050513          	addi	a0,a0,1728 # 80020868 <itable>
...
00000000800031c0 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003202:	6625a583          	lw	a1,1634(a1) # 80020860 <sb+0x18>
...
0000000080003342 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003352:	51a50513          	addi	a0,a0,1306 # 80020868 <itable>
  ...
  release(&itable.lock);
    ...
    8000336c:	50050513          	addi	a0,a0,1280 # 80020868 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003398:	4d450513          	addi	a0,a0,1236 # 80020868 <itable>
    ...
    800033be:	4ae50513          	addi	a0,a0,1198 # 80020868 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800038dc:	a3890913          	addi	s2,s2,-1480 # 80022310 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800038fc:	a4870713          	addi	a4,a4,-1464 # 80022340 <log+0x30>
...
000000008000392a <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000392e:	a127a783          	lw	a5,-1518(a5) # 8002233c <log+0x2c>
    80003932:	08f05f63          	blez	a5,800039d0 <install_trans+0xa6>
{
    ...
    80003950:	9f4a8a93          	addi	s5,s5,-1548 # 80022340 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003954:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003956:	0001f997          	auipc	s3,0x1f
    8000395a:	9ba98993          	addi	s3,s3,-1606 # 80022310 <log>
...
00000000800039d2 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    800039e8:	92c48493          	addi	s1,s1,-1748 # 80022310 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003a1e:	92670713          	addi	a4,a4,-1754 # 80022340 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003a40:	9007a023          	sw	zero,-1792(a5) # 8002233c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003a66:	8ae50513          	addi	a0,a0,-1874 # 80022310 <log>
    80003a6a:	98afd0ef          	jal	80000bf4 <acquire>
  while(1){
    if(log.committing){
    80003a6e:	0001f497          	auipc	s1,0x1f
    80003a72:	8a248493          	addi	s1,s1,-1886 # 80022310 <log>
      sleep(&log, &log.lock);
    ...
    80003aaa:	86a50513          	addi	a0,a0,-1942 # 80022310 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003ad0:	84448493          	addi	s1,s1,-1980 # 80022310 <log>
  ...
  if(log.outstanding == 0){
    ...
    80003af0:	82448493          	addi	s1,s1,-2012 # 80022310 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003b08:	80c48493          	addi	s1,s1,-2036 # 80022310 <log>
    ...
    80003b3a:	7da48493          	addi	s1,s1,2010 # 80022310 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003b60:	7e4a8a93          	addi	s5,s5,2020 # 80022340 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003b64:	0001ea17          	auipc	s4,0x1e
    80003b68:	7aca0a13          	addi	s4,s4,1964 # 80022310 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003bca:	7607ab23          	sw	zero,1910(a5) # 8002233c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003bec:	72890913          	addi	s2,s2,1832 # 80022310 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003c26:	71e70713          	addi	a4,a4,1822 # 80022340 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c42:	6d278793          	addi	a5,a5,1746 # 80022310 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003c56:	6be70713          	addi	a4,a4,1726 # 80022310 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c84:	69070713          	addi	a4,a4,1680 # 80022310 <log>
  ...
  release(&log.lock);
    ...
    80003c96:	67e50513          	addi	a0,a0,1662 # 80022310 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003dbc:	6a050513          	addi	a0,a0,1696 # 80022458 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003dda:	68250513          	addi	a0,a0,1666 # 80022458 <ftable>
    80003dde:	e17fc0ef          	jal	80000bf4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003de2:	0001e497          	auipc	s1,0x1e
    80003de6:	68e48493          	addi	s1,s1,1678 # 80022470 <ftable+0x18>
    80003dea:	0001f717          	auipc	a4,0x1f
    80003dee:	62670713          	addi	a4,a4,1574 # 80023410 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    80003e02:	65a50513          	addi	a0,a0,1626 # 80022458 <ftable>
  ...
  return 0;
    ...
    80003e16:	64650513          	addi	a0,a0,1606 # 80022458 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e3a:	62250513          	addi	a0,a0,1570 # 80022458 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003e50:	60c50513          	addi	a0,a0,1548 # 80022458 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e80:	5dc50513          	addi	a0,a0,1500 # 80022458 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003ebe:	59e50513          	addi	a0,a0,1438 # 80022458 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003ef6:	56650513          	addi	a0,a0,1382 # 80022458 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004018:	3a470713          	addi	a4,a4,932 # 800223b8 <devsw>
    ...
    80004052:	10078b63          	beqz	a5,80004168 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800040ba:	30270713          	addi	a4,a4,770 # 800223b8 <devsw>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  ustack[argc] = 0;
    ...
    800046ca:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdba40>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    800052e4:	13078793          	addi	a5,a5,304 # 80023410 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    800052f8:	11c78793          	addi	a5,a5,284 # 80023410 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005320:	10c50513          	addi	a0,a0,268 # 80023428 <disk+0x18>
...
0000000080005348 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005360:	1dc50513          	addi	a0,a0,476 # 80023538 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    800053c8:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdb20f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000541e:	ff648493          	addi	s1,s1,-10 # 80023410 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000543c:	fe073703          	ld	a4,-32(a4) # 80023418 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005454:	fc048493          	addi	s1,s1,-64 # 80023410 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005570:	fcc50513          	addi	a0,a0,-52 # 80023538 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005580:	e94b0b13          	addi	s6,s6,-364 # 80023410 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    8000558a:	fb2c0c13          	addi	s8,s8,-78 # 80023538 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800055ac:	e6870713          	addi	a4,a4,-408 # 80023410 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800055e4:	e4850513          	addi	a0,a0,-440 # 80023428 <disk+0x18>
  ...
  if(write)
    ...
    80005600:	e1478793          	addi	a5,a5,-492 # 80023410 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800056d6:	e6690913          	addi	s2,s2,-410 # 80023538 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800056fe:	d1678793          	addi	a5,a5,-746 # 80023410 <disk>
    80005702:	97ba                	add	a5,a5,a4
    80005704:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005708:	0001e997          	auipc	s3,0x1e
    8000570c:	d0898993          	addi	s3,s3,-760 # 80023410 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80005730:	e0c50513          	addi	a0,a0,-500 # 80023538 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005760:	cb448493          	addi	s1,s1,-844 # 80023410 <disk>
    80005764:	0001e517          	auipc	a0,0x1e
    80005768:	dd450513          	addi	a0,a0,-556 # 80023538 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800057dc:	d6050513          	addi	a0,a0,-672 # 80023538 <disk+0x128>
