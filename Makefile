...
#chamhed the position of the flags as they should be before the objs
ifndef TOOLPREFIX
...
#important to be able to run datetime system call as i cant call it before sending epoch
